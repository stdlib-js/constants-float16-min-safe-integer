...
```javascript
FLOAT16_MIN_SAFE_INTEGER = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-min-safe-integer@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-min-safe-integer@v0.2.0-umd/browser.js"></script>
```
